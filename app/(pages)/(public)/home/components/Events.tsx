...
const Events = () => {
  ...
  return (
    <div className='relative w-full py-8 px-4 sm:px-8 h-fit min-h-[80vh]'>
      <div className='absolute top-0 left-0 right-0 z-10 h-32 bg-gradient-to-b from-purple-900/50 to-transparent pointer-events-none ' />
        <div className='absolute inset-0 bg-gradient-to-b from-black/70 to-black/40 z-0'></div>
        <div className='relative z-10'>
        <div className='flex justify-between items-center mb-6'>
          <div className='absolute h-58 w-58 bg-yellow-400/30 top-5 blur-3xl'></div>
          <h1 className='text-white text-3xl sm:text-4xl font-bold'>
            Upcoming Events
          </h1>
          <div className='flex gap-10 items-center'>
            <div className='absolute h-58 w-58 bg-purple-400/30 top-10 blur-3xl'></div>
            <Link href='/events'><p className='text-gray-400 hover:text-white hover:scale-105 transition-all duration-300 cursor-pointer'>Show More →</p></Link>
        ...
        <div
          ...
          className='flex gap-[40px] overflow-x-auto overflow-y-hidden pb-[30px] cursor-grab select-none'
          style={{
            scrollbarWidth: 'none',
